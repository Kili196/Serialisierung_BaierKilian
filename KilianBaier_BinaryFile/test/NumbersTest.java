...
public class NumbersTest extends FileBasedTest {
    ...
    @Test
    public void getsContentt() throws IOException {
        List<Number> expected = List.of(3.141592653589793, 2.718281828459045, 1.41, 5, 3.141592653589793, 2.718281828459045, 1.41, 5);
        Numbers.createFile(TESTFILE_NAME, expected);
        List<Number> result = Numbers.getContents(TESTFILE_NAME);
        assertEquals(expected, result);
    }
