...
public interface Map<K, V> {
    /*** Fuegt ein  neues  Key - Value  - Paar  dieser  pairmap.Map  hinzu.* Sollte  der Key  schon  existieren ,
    ...
    /*** Liefert  die  Anzahl  der Key - Value  - Paare  in  dieser  pairmap.Map.**
     * @return  Anzahl  der  Eintr ̈age in  dieser  pairmap.Map*/
    int size();
}
